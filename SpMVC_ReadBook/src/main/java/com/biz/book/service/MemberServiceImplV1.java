 ...
 * private final로 선언된 객체에 @Autowired를 설정하고
 * Container로 부터 객체를 주입받아 사용할수 있도록 만들어주는 
 * lombok의 Annotation이다. 
 * 
 * MemberSErviceImlV1(PassowrdEncoder passwordEncoder){
...
public class MemberServiceImplV1 implements MemberService {
	...
	// 회원정보 권한(ROLE)정보 CRUD 구현
	private final AuthorityDao authDao;

	/*
	 * 컨트롤러에서 회원정보를 전달받아서 비밀번호를 암호화 하고 userDao에 보내서 저장하기
	 * 
