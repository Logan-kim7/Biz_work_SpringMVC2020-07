...
<script>
	document.addEventListener("DOMContentLoaded", function(){
		...
		/*
			tag와 tag들이 서로감싸는 관계로 layout이 만들어져 있을때 
			tag들의 click event 핸들링이 설정 되어있으면 
			어떤 특정 tag를 click 했을때 원하지 않는 event가 발생하는 경우가 있다.
			이러한 현상을 event 버블링 이라고 한다.
			tag box의 가장 중간 부분에 있는 tag를 클릭하면 안쪽부터 바깥쪽으로
			계속해서 이벤트가 전해지는 현상
