...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		/*
		 * Controller의 method에서 home문자열을 return하면
		 ...
		 * 4. tiles-layout.xml의 put-attribute로 서언된 이름을 비교한다.
		 * 5. 일치하는 이름이 있으면 value로 선언된 *.jsp 파일을 가져와서
		 * 6. layout.jsp 파일과 합성하여 rendering을 준비한다.
		 * 
		 * 7. 만약 home이라고 선언된 항목이 tiles-layout.xml에 없을 경우는
		 * 8. 원래 설계된 순서대로 InternalViewResolver가 작동되어 /WEB-INF/views 
		 *    폴더에서 home.jsp파일을 찾아서 rendering 한다.
		 * 
		 */
		return "home";
	}
